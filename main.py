    ...
    if ctx.guild.id != 861018927752151071:
        ...
        async with ctx.typing():
            ...
            await bot.change_presence(
                activity=discord.Activity(type=discord.ActivityType.listening, name=f"{bot.count} interviews"))
            ...
            msg = await answer_channel.send(embed=embed, components=[action_row])
            ctx: ComponentContext = await wait_for_component(bot, components=action_row, messages=msg)
